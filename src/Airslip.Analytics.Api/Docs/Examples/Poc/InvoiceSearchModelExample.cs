...
public class InvoiceSearchModelExample : IExamplesProvider<EntitySearchResponse<InvoiceModel>>
{
    public EntitySearchResponse<InvoiceModel> GetExamples()
    {
        return new EntitySearchResponse<InvoiceModel>
        {
