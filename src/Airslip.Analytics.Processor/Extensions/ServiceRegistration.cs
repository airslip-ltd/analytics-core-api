...
public static class ServiceRegistration
{
    public static void RegisterHandoff(MessageHandoffOptions handoff)
    {
        ...
        handoff.Register<IRegisterDataService<BankAccount, BankAccountModel, RawYapilyAccountModel>>(Constants.EVENT_QUEUE_YAPILY_ACCOUNTS, DataSources.Yapily);
        ...
        handoff.Register<IRegisterDataService<MerchantAccount, MerchantAccountModel, RawApi2CartAccountModel>>(Constants.EVENT_QUEUE_API_2_CART_ACCOUNTS, DataSources.Api2Cart);
    }
