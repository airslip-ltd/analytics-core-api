...
public static class BankingBanks
{
    [Function(nameof(BankingBanks))]
    public static async Task Run([EventHubTrigger(Constants.EVENT_HUB_BANKING_BANKS, 
        ...
        IsBatched = false)] string myEventHubMessage, FunctionContext context)
    {
        ...
        await messageService.ProcessMessage(Constants.EVENT_HUB_BANKING_BANKS, myEventHubMessage);
    }
}