...
{
    [Function(nameof(BankingTransactions))]
    public static async Task Run([EventHubTrigger(Constants.EVENT_HUB_BANKING_TRANSACTIONS, 
        ...
        IsBatched = false)] string myEventHubMessage, FunctionContext context)
    {
        ...
        await messageService.ProcessMessage(Constants.EVENT_HUB_BANKING_TRANSACTIONS, myEventHubMessage);
    }
}