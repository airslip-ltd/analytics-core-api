...
public static class BankBalanceEntityAnalysis
{
    [Function("BankBalanceEntityAnalysis")]
    public static async Task Run([ServiceBusTrigger(Constants.MESSAGE_QUEUE_BANK_ACCOUNT_BALANCE_ENTITY, 
        ...
        string message, FunctionContext context)
    {
        ...
        await messageService.ProcessMessage(Constants.MESSAGE_QUEUE_BANK_ACCOUNT_BALANCE_ENTITY, message);
    }
}