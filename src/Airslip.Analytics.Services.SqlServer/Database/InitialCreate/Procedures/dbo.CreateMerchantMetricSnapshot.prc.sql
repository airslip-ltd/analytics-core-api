create or alter dbo.CreateMerchantMetricSnapshot(
...
insert (EntityId, AirslipUserType, Year, Month, Day, TotalSales, SaleCount, TotalRefunds, RefundCount)
VALUES (@EntityId, @AirslipUserType, @Year, @Month, @Day, y.TotalSales, y.SaleCount, y.TotalRefunds,
    y.RefundCount);
go
