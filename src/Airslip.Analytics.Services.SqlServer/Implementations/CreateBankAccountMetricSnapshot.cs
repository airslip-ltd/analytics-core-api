...
public class CreateBankAccountMetricSnapshot : IAnalyticsProcess<BankTransactionModel>
{
    private readonly DbContext _context;

    public CreateBankAccountMetricSnapshot(IContext context)
    {
    ...
    public Task<int> Execute(BankTransactionModel model)
    {
