...
namespace Airslip.Analytics.Services.SqlServer.Migrations
{
    ...
    [Migration("20220503071958_LongRunningQueries")]
    partial class LongRunningQueries
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Airslip.Analytics.Core.Entities.BankTransaction", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("EntityId", "AirslipUserType"), new[] { "IntegrationProviderId" });

                    b.HasIndex("AirslipUserType", "EntityId", "Day", "Month", "Year");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("AirslipUserType", "EntityId", "Day", "Month", "Year"), new[] { "IntegrationId", "Amount", "IntegrationProviderId" });
            ...
            modelBuilder.Entity("Airslip.Analytics.Core.Entities.IntegrationProvider", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_IntegrationProviders_Id");
            ...
            modelBuilder.Entity("Airslip.Analytics.Core.Entities.MerchantAccountMetricSnapshot", b =>
                {
                    ...
                    b.HasIndex("Day", "Month", "Year", "EntityId", "AirslipUserType", "IntegrationId", "CurrencyCode");
            ...
            modelBuilder.Entity("Airslip.Analytics.Core.Entities.Unmapped.CurrencySnapshot", b =>
                {
                    b.Property<string>("CurrencyCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Airslip.Analytics.Core.Entities.Integration", b =>
                {
                    ...
                    b.HasOne("Airslip.Analytics.Core.Entities.IntegrationProvider", "Provider")
